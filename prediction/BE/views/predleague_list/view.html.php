...
class JoomsportViewpredleague_list extends JViewLegacy
{
    public $_model = null;
    ...
    protected function addToolbar()
    {
        if (JFactory::getUser()->authorise('core.edit', 'com_joomsport')) {
            JToolBarHelper::addNew('predleague_add');
            JToolBarHelper::editList('predleague_edit');
        }
        JToolBarHelper::title(JText::_('JSPL_PREDICTION_LIST'), 'player.png');
        if (JFactory::getUser()->authorise('core.delete', 'com_joomsport')) {
            JToolBarHelper::deleteList('', 'predleague_del', JText::_('BLBE_DELETE'));
        }
    }
}
